...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Consultas Matrimonios</title>
    ...
    <body>            
        <div class="flex-center position-ref full-height">         
            ...
            <div class="title m-b-xs">
                ...
                <form action="{{ url('matrimonios') }}" method="post" accept-charset="utf-8">
                @csrf
                  <div class="contact-form">                  
                     <div class="form-group">
                                           
                        <div class="col-sm-12">          
                            <label class="col126" for="fdpi">Ingrese el número de DPI:</label>
